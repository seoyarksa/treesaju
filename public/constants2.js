...
export const 태과불급map = {
  //당령기준 원인은 태과, 불급, 투간---> 당령해당글자는 가 강해지면 태과, 약해지면 불급
  '癸': {
    태과: [
      { 구분: '태과', 원인: '辛', tags: ['금한수냉(金寒水冷)'], 조건:{글자:'', 설명2:'' }, 藥: [{글자:'丙', 설명:'얼어붙은 불안한, 걱정적 환경에 희망을 품고 자기계발함, 좋은 인연과 부모덕을 받음'}, 
                                           {글자: '己', 설명:'한기를 막아 보온작용, 자제력이 있고, 재능개발에 노력한다' }] },   // 금수 과잉 → 화 필요
      { 구분: '태과', 원인: '癸', tags: ['수다목부(水多木腐)'], 조건:{글자:'', 설명2:'' }, 藥:[{글자: '庚', 설명:'물이 고여 정신이 썩고 문드러졌지만 다시 흘러감. 심리치료사'},
                                          {글자: '己', 설명:'과한 물을 막고 습윤하여 자기에게 맞는 지식만 습득하게하여 혼란을 막는다'},
                                          {글자: '丙', 설명:'미래 희망을 갖고 목적의식을 가지게 하여 과잉된 물을 활기차게 사용한다'}]},
    ],
    투간: [
      { 구분: '투간', 원인: '戊', tags: ['돈후(敦厚)'], 조건:{글자:'', 설명2:'' }, 藥: '庚', 설명:'어린싹에게 땅이 너무 두터워 볕이 들지 않으니 지식이 늘지 않아서 기술을 익히게 된다.'  }, //戊 투간시
      { 구분: '투간', 원인: '', tags: [''], 조건:{글자:'', 설명2:'' }, 藥: '' , 설명:'' },             
    ],
    불급: [
      { 구분: '불급', 원인: '戊', tags: ['토다회화(土多晦火)'], 조건:{글자:'丙', 설명2:'천간에 丙이 있어야 회화작용을 가짐' }, 藥: '庚', 설명:'戊가 丙을 가려 재능이 가려 만능2인자가 되거나 시골생활을 하게되는데 약이 있으면 기술자가 된다'  },      
      { 구분: '불급',원인: '丙', tags: ['화다수갈(火多水渴)'], 조건:{글자:'癸', 설명2:'천간에 癸가 있고 금생수가 되지 않아야 화다수갈임' }, 藥: '庚' , 설명:'희망과 꿈만 크고 실력부족한 상태로 일찍 사회진출하지만 藥이 있으면 지속적인 실력쌓기가 가능함 ' },             
    ]
  },

//'丙', 설명:'추워서 나무가 자라지 못하니 배워서 세상밖으로 나갈 마음이 안생기는 현상, 藥이 있으면 목료' 

  '甲':{
    태과: [
      { 구분: '태과', 원인: '辛', tags: ['금한수냉(金寒水冷)'], 조건:{글자:'', 설명2:'' },  藥:[{글자: '己', 설명:'한기를 막고 자신에게 적합한 지식을 습득'},
                                          {글자: '庚', 설명:'열매(庚)라는 미래를 위해서 참고 인내함'},
                                          {글자: '丙', 설명:'한기를 녹여서 세상에 대한 두려움을 없애고 목표를 가지고 나아감 '}]},
      { 구분: '태과', 원인: '癸', tags: ['수다목부(水多木腐)'], 조건:{글자:'', 설명2:'' },  藥:[{글자: '己', 설명:'장소를 옮겨서 나에게 맞는 환경을 찾는다, 나에게 맞는 지식만 습득한다'},
                                          {글자: '戊', 설명:'지식쪽이 아닌 예능,기술쪽으로 전공을 바꾼다'}]},
      { 구분: '태과', 원인: '甲', tags: ['목다수축(木多水縮)'], 조건:{글자:'', 설명2:'' }, 藥:[{글자: '辛', 설명:'丙이 투간하면 많은 나무들의 성장으로 물이 부족해져서 끝에가서 일이 틀어짊, 藥이 있으면 필요한 것만 전문적으로 하게 됨 '},
                                         {글자: '庚', 설명:'丙이 투간하여 많은 나무들의 성장으로 물이 부족해져서 끝에가서 일이 틀어짊, 藥이 있으면 전공을 바꾸게 된다'}]},   // 목수 과잉 → 금 필요   
       
    ],
    불급: [
      { 구분: '불급', 원인: '丙', tags: ['화다수갈(火多水渴)'], 조건:{글자:'', 설명2:'' },  藥: '庚' , 설명:'나무가 크게 성장후 물이 부족한 현상으로 배운것을 활용하지 못함, 藥이 있으면 금극목으로 새로운 것을 배워 진로변경 ' },
      { 구분: '불급', 원인: '', tags: [''],  조건:{글자:'', 설명2:'' }, 藥: '', 설명:'' },             
    ],
    투간: [
      { 구분: '투간', 원인: '戊', tags: ['폐문(閉門)'],  조건:{글자:'', 설명2:'' }, 藥: '庚', 설명:'癸라는 물(지식)을 막아 공부를 하지 못함. 藥이 있으면 기술(건축,토목)을 배운다. '  }, //戊 투간시
      { 구분: '투간', 원인: '', tags: [''],  조건:{글자:'', 설명2:'' }, 藥: '' , 설명:'' }]    
  },
  '乙':{
    태과: [
      { 구분: '태과', 원인: '乙', tags: ['목다화식(木多火熄)'],  조건:{글자:'', 설명2:'' }, 藥: '辛', 설명:'젖은 목이 불을 꺼뜨리는 현상으로 가지를 치고 말려서 사용한다'  },   
      { 구분: '태과', 원인: '丙', tags: ['화다목고(火多木枯)'],  조건:{글자:'', 설명2:'' }, 藥: '戊', 설명:'불이 강해 나무가 마르니 탈진함. 藥으로 차양함(긴축재정 및 조직개편하는 모습), 藥이 없으면 조직사회도피'  },   //여기선 丙+丁도 多
      { 구분: '태과', 원인: '辛', tags: ['금한수냉(金寒水冷)'], 조건:{글자:'', 설명2:'' }, 藥: '丙', 설명:'사회에 나아가지 않으려고 함(보수적,안정추구주의), 藥이 있어야 목표를 두고 사회생활을 함 '  }
    ],
    불급: [
      { 구분: '불급', 원인: '戊', tags: ['토다회화(土多晦火)'],  조건:{글자:'丙', 설명2:'丙이 있어야만 태양을 가릴 수 있다' }, 藥: '庚', 설명:'丙을 가려서 자태가 드러나지 못함, 藥이 있으면 땅을 파내서 자태를 드러냄'  },
      { 구분: '불급', 원인: '', tags: [''],  조건:{글자:'', 설명2:'' }, 藥: '', 설명:''  },             
    ],
    투간: [
      { 구분: '투간', 원인: '乙', tags: ['음습(陰濕)'],  조건:{글자:'', 설명2:'' }, 藥: '辛', 설명:'가지가 너무 자라서 태양을 가려 음습해짐, 절지(折枝)로 가지를 쳐냄(대인관계정리)'  }, //戊 투간시
      { 구분: '투간', 원인: '癸', tags: ['과습(過濕)'],  조건:{글자:'', 설명2:'' }, 藥: '庚' , 설명:'생각이 많아져 스트레스 우울증상, 藥이 있으면 습기를 제거(심리상담사)' }],    
   
    불투: [
      { 구분: '불투', 원인: '戊', tags: ['고목[枯木)'],  조건:{글자:'丙', 설명2:'화가 투출했는데 戊가 없으면 차양이 안됨' }, 藥: '戊', 설명:'뜨거운 햇빛을 戊로 차양해서 나무가 시들지 않게 함, 열악한 환경이 개선됨'}, //戊 투간시
    ]
  },
  
  '丙':{
    태과: [
      { 구분: '태과', 원인: '丙', tags: ['화다목고(火多木枯)','화다수갈(火多水渴)'],  조건:{글자:'', 설명2:'' }, 藥: '戊', 설명:'화다하여 나무가 마르고 물이 고갈됨(사회적 능력부족). 藥으로 차양함(긴축재정 및 지역변경을 통한 구조조정)'  },   //여기선 丙+丁도 多 
      { 구분: '태과', 원인: '庚', tags: ['금다목절(金多木折)'],  조건:{글자:'乙', 설명2:'투간된 을목이 多한 庚의 극을 받는다' }, 藥: '甲', 설명:'공약(목표,광고)만 많고 지나쳐 사람(乙)을 혹사시킴, 약이 있으면 벽갑으로 실속적 판단, 乙은 甲에게 의지'  },
      { 구분: '태과', 원인: '', tags: [''],  조건:{글자:'', 설명2:'' }, 藥: '', 설명:''  },   
    ],
    불급: [
      { 구분: '불급', 원인: '戊', tags: ['토다회화(土多晦火)'],  조건:{글자:'丙', 설명2:'丙이 있어야만 태양을 가릴 수 있다' }, 藥: '庚', 설명:'丙을 가려서 꽃이 열매를 맺지 못하고 열매가 크지를 못함, 좋은 성과를 내지 못함, 庚으로 땅을 파서 볕이 들게 해야함'  },
      { 구분: '불급', 원인: '庚', tags: ['금불급'],  조건:{글자:'庚', 설명2:'庚이 하나도 없음' }, 藥: '庚' , 설명:'庚은 열매인데 이게 하나도 없으니 목표가 없고 결과가 없으니 성공하지 못한다.' },             
    ], 
    투간: [
      { 구분: '투간', 원인: '乙', tags: ['음습(陰濕)'],  조건:{글자:'', 설명2:'' }, 藥: '辛', 설명:' 무성한 가지가 태양을 가려 음습해짐, 辛으로 절지(折枝)로 무성한 가지를 쳐냄(대인관계정리)'  }, //戊 투간시
      { 구분: '투간', 원인: '癸', tags: ['과습(過濕)'],  조건:{글자:'', 설명2:'' }, 藥: '庚' , 설명:'대인관계 스트레스, 우울증상, 의심집착증 발생, 藥이 있으면 습기를 제거(대인관계 컨설팅)' }]
  },
  '丁':{
    태과: [
      { 구분: '태과', 원인: '丁', tags: ['화다목분'],  조건:{글자:'乙', 설명2:'목다화치(木多火熾)의 한 현상으로 火가 치열한 상태 + 乙투간시 발생' },
                                                                  藥:[{글자: '壬', 설명:''},
                                                                      {글자: '甲', 설명:' '}]},  
      { 구분: '태과', 원인: '丁', tags: ['화다금소'],  조건:{글자:'辛', 설명2:'목다화치(木多火熾)의 한 현상으로 火가 치열한 상태 + 辛투간시 발생' },
                                                                  藥:[{글자: '', 설명:''},
                                                                      {글자: '', 설명:' '}]},    
      { 구분: '태과', 원인: '丁', tags: ['화다토조'],  조건:{글자:'己', 설명2:'목다화치(木多火熾)의 한 현상으로 火가 치열한 상태 + 己투간시 발생' },
                                                                  藥:[{글자: '', 설명:''},
                                                                      {글자: '', 설명:' '}]},     
      { 구분: '태과', 원인: '丙', tags: ['화다목분'],  조건:{글자:'乙', 설명2:'목다화치(木多火熾)의 한 현상으로 火가 치열한 상태 + 乙투간시 발생' },
                                                                  藥:[{글자: '壬', 설명:''},
                                                                      {글자: '甲', 설명:' '}]},  
      { 구분: '태과', 원인: '丙', tags: ['화다금소'],  조건:{글자:'辛', 설명2:'목다화치(木多火熾)의 한 현상으로 火가 치열한 상태 + 辛투간시 발생' },
                                                                  藥:[{글자: '', 설명:''},
                                                                      {글자: '', 설명:' '}]},    
      { 구분: '태과', 원인: '丙', tags: ['화다토조'],  조건:{글자:'己', 설명2:'목다화치(木多火熾)의 한 현상으로 火가 치열한 상태 + 己투간시 발생' },
                                                                  藥:[{글자: '', 설명:''},
                                                                      {글자: '', 설명:' '}]},                                                                                                                                                                                             
      { 구분: '태과', 원인: '', tags: [''],  조건:{글자:'', 설명2:'' }, 藥: '', 설명:''  },   
    ],
